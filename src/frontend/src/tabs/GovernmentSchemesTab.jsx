// src/tabs/GovernmentSchemesTab.jsx
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {schemes.map((scheme) => (
                    <a 
                        ...
                        className={`group relative bg-gradient-to-br ${scheme.theme} p-1 rounded-3xl transition-all duration-300 hover:-translate-y-2 hover:shadow-xl block`}
                    >

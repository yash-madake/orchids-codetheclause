...
const InsuranceTab = ({ data, refreshData }) => {
    ...
    const handleFileUpload = (e) => {
        ...
        reader.onload = (event) => {
            ...
            // Assuming MockBackend is available in scope or imported
                ...
                <div className="bg-white/40 backdrop-blur-md rounded-[20px] p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8 relative z-10">
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                            <a href="https://pmjay.gov.in/" target="_blank" rel="noreferrer" className="bg-slate-900 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:bg-slate-800 transition flex items-center gap-2">
                                Check Eligibility <i className="ph-bold ph-arrow-up-right"></i>
                            </a>
                            <a href="https://beneficiary.nha.gov.in/" target="_blank" rel="noreferrer" className="bg-white text-slate-800 px-6 py-3 rounded-xl font-bold shadow-sm hover:bg-amber-50 transition border border-amber-200">
                                Download Card
                            </a>
                        </div>
                    </div>
